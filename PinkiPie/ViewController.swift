...
class ViewController: UIViewController {
    ...
    @IBAction func saveButtonPressed(_ sender: UIButton) {
        ...
        //HiddenMessageLabel.isHidden = true
    }
    ...
    override func shouldPerformSegue(withIdentifier identifier: String, sender: Any?) -> Bool {
        ...
        createData_(name: nameLabel.text!, weight: (weightLabel.text! as NSString).doubleValue, height: (heightLabel.text! as NSString).doubleValue)
        return true
    }
    
    func createData_(name: String, weight: Double, height: Double) {
...
//        updateHealthInfo()
        ...
        /*if (!retrieveData()){
         createData_(name: "Veronika", weight: 43.0, height: 153.0)
         }*/
        //let bool = retrieveData()
